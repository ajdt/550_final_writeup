...
\section{Known results}
	...
	\begin{figure}[H]
		...
		\end{tikzpicture}
			\caption{Leader Election solves APF} \label{fig:hi}
		\end{subfigure}
	...
	\begin{figure}[H]
		...
		\begin{tikzpicture}[scale=0.50]
			...
			\node[right] at (5,6) {$v_2$} ;
		\end{tikzpicture}
			\caption{Leader is elected} \label{fig:hi}
		\end{subfigure}
	...
	\begin{proof}
		The proof follows easily when we consider the right counterexample as in \ref{evenfig2}. Even
		...
		$r_j$ with a symmetric view of the world. In \ref{evenfig2} $r_2$ and $r_4$ have symmetric
	...
	\begin{figure}[H]
		...
		\begin{tikzpicture}[scale=0.50]
			...
			\node[above] at (4, 5) {$x$};
		\end{tikzpicture}
			\caption{Initial Configuration} \label{fig:hi}
		\end{subfigure}
		\caption{APF Solved for odd $n$ }
	\end{figure}
