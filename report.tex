...
\begin{figure}[H]
	...
	\begin{tikzpicture}[scale=0.60]
					...
					\node[right] at (6,2) {$x$} ;
	\end{tikzpicture}
	\caption{Consistent Compass: All compasses oriented the same}
	\label{compfig1}
	\end{subfigure}
	\begin{subfigure}{0.5\textwidth}
	\centering
	\begin{tikzpicture}[scale=0.60]
					...
					\node[right] at (6,2) {$x$} ;
	\end{tikzpicture}
		\caption{OneAxis: Only the y axis is consistent among all robots} 
		\label{compfig2}
	\end{subfigure}
	\caption{Compass orientation assumptions}
	\label{comp}
\end{figure}
...
\subsection{PUDDLE: A OneAxis Even $n$ Algorithm } 
	...
	\subsection{PUDDLE runs in linear time} 
		...
		% TODO: show steps in this equation
